...
export default function Home() {
  ...
  return (
    <main className="">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-5 w-full max-w-lg">
        {/* MAIN CARD */}
        <div className="w-full border p-6 rounded-2xl backdrop-blur-2xl">
        ...
        <p className="text-sm text-muted-foreground font-medium">
          <a
            href="https://docs.google.com/forms/d/e/1FAIpQLScvSGDzvizF7aU1PFN8a-Fwrlw_z91hhNNZ6hY3TODnHiYHYw/viewform?usp=publish-editor"
            target="_blank"
